    ...
    _defineProperty(_assertThisInitialized(_this), "playAudio", function (previewUrl) {
      return function () {
        if (!previewUrl) {
          ...
          alert('No preview found for album!');
...
var API_ADDRESS = 'https://spotify-api-wrapper.appspot.com/artist';
...
var App = /*#__PURE__*/function (_Component) {
  ...
  function App() {
    ...
    _defineProperty(_assertThisInitialized(_this), "searchArtist", function (artistQuery) {
      fetch("".concat(API_ADDRESS, "/").concat(artistQuery)).then(function (response) {
        ...
        if (json.artists.total > 0) {
          ...
          fetch("".concat(API_ADDRESS, "/").concat(_this.state.artist.id, "/top-tracks")).then(function (response) {
            return response.json();
          }).then(function (json) {
